...
serve(async (req) => {
  ...
  const html = `
    <div style="font-family:monospace;max-width:560px;margin:0 auto;background:#080c12;color:#e2e8f0;padding:32px;border-radius:12px;border:1px solid rgba(0,229,204,0.2)">
      ...
      <p style="margin:0 0 8px"><strong style="color:#00e5cc">Name:</strong> ${name}</p>
      <p style="margin:0 0 8px"><strong style="color:#00e5cc">Email:</strong> <a href="mailto:${email}" style="color:#00e5cc">${email}</a></p>
      <p style="margin:0 0 16px"><strong style="color:#00e5cc">Message:</strong></p>
      <div style="background:rgba(0,229,204,0.06);border-left:3px solid #00e5cc;padding:16px;border-radius:4px;white-space:pre-wrap">${message}</div>
