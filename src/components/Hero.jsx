  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        {/* Main headline — leads with value, not a word cycle */}
        <div className="reveal visible" style={{ marginBottom: 8 }}>
          ...
          <h1 style={{
            ...
            {/* Primary value prop — immediately scannable */}
            <span style={{ display: 'block' }}>
              I build{' '}
              <span className="grad-text">web apps</span>,
            </span>
            <span style={{ display: 'block' }}>
              <span className="grad-text">AI tools</span>
              {' '}&amp; software
            </span>
            <span style={{
              display: 'block',
        ...
        {/* Description — specific, client-oriented */}
        <p className="reveal visible" style={{
          color: 'var(--muted)', fontSize: 17,
          maxWidth: 540, lineHeight: 1.8, marginBottom: 16,
        }}>
          Full-stack developer building{' '}
          <span style={{ color: 'var(--text)' }}>React web apps</span>,{' '}
          <span style={{ color: 'var(--text)' }}>AI integrations</span>, and{' '}
          <span style={{ color: 'var(--text)' }}>custom software</span> for
        ...
        <p className="reveal visible" style={{
          ...
          maxWidth: 540, marginBottom: 40, letterSpacing: 0.5,
        }}>
          Based in{' '}
          <span style={{ color: 'var(--cyan)' }}>Windhoek, Namibia</span>{' '}
          — working with clients worldwide.
        </p>

        {/* CTA Buttons — primary action first, clearly differentiated */}
        <div className="reveal visible" style={{
          ...
          <a href="#projects" className="btn-hero-secondary" style={{ textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: 8 }}>
            View Projects →
          </a>

          {/* TERTIARY: quick actions */}
          <a href="#services" className="btn-hero-ghost" style={{ textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: 8 }}>
            Services
          </a>
